    ...
    <div className="min-h-screen bg-gray-200 pb-12 print:bg-white print:pb-0">
      ...
      <div className="print:w-full print:m-0 w-full max-w-[210mm] mx-auto flex flex-col gap-8 print:gap-0 font-sans">
        ...
        {dataSapi.map((sapi, index) => (
          <div key={`sapi-${index}`} className="page-break bg-white shadow-2xl print:shadow-none p-10 print:p-8 flex flex-col justify-center w-full min-h-[297mm] print:min-h-0 border-8 border-black">
            
            <div className="text-center mb-12 border-b-8 border-black pb-8">
              <h1 className="text-7xl font-black uppercase tracking-widest text-black">
                SAPI
              </h1>
              <h2 className="text-6xl font-bold mt-4 text-black bg-gray-200 inline-block px-8 py-2 rounded-2xl">
                {sapi.kelompok}
              </h2>
            </div>

            <ol className="list-decimal list-inside text-[42px] leading-snug font-bold text-black space-y-6 px-4">
        ...
        {dataKambing.map((kambing, index) => (
          <div key={`kambing-${index}`} className="page-break bg-white shadow-2xl print:shadow-none p-10 print:p-8 flex flex-col items-center justify-center text-center w-full min-h-[297mm] print:min-h-0 border-8 border-black">
            
            <div className="w-full border-b-8 border-black pb-12 mb-12">
              <h1 className="text-[100px] font-black uppercase tracking-widest text-black leading-none">
                KAMBING
              </h1>
            </div>

            <h2 className="text-7xl font-black text-black leading-tight px-4 uppercase bg-gray-200 py-6 rounded-3xl w-full">
              {kambing}
            </h2>
